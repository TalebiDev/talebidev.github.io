  ...
  (function(){
    ...
    function updateAvatarImage(isLight){
      if (!avatarImg) return;
      const nextSrc = isLight ? avatarImg.dataset.nobg : avatarImg.dataset.bg;
      if (nextSrc && avatarImg.getAttribute('src') !== nextSrc){
